...
function State = EvaluateInputData(State)
    %% 1. Clear the sub-structs State.Dependents.Device and State.Dependents.Data.
    State.Dependents.Device = struct;
    State.Dependents.Data = struct;
    %% 2. Read the selected input file.
    ...
    %% 5. Evaluate the size of the experimental data for each {Type, Test}.
    ...
    %% 6. Evaluate the number of combinations of {Type, Test}.
    ...
    %% 7. Evaluate the experimental variance.
    ...
    %% 8. Parse the fitting definitions for the charge trapping shift.
    ...
    %% 9. Reshape the fitting definitions for the charge trapping shift.
