...
function State = EvaluateOptimiser(State)
    ...
    State.Dependents.Optimiser.InitialValues = [State.Dependents.Optimiser.InitialValues, reshape(cellfun(@(Parameter) Parameter{2} ./ Parameter{1}, State.Dependents.FittingDefinitions.ChargeTrappingShift), 1, [])];
    State.Dependents.Optimiser.LowerBounds = [State.Dependents.Optimiser.LowerBounds, reshape(cellfun(@(Parameter) Parameter{3} ./ Parameter{1}, State.Dependents.FittingDefinitions.ChargeTrappingShift), 1, [])];
    State.Dependents.Optimiser.UpperBounds = [State.Dependents.Optimiser.UpperBounds, reshape(cellfun(@(Parameter) Parameter{4} ./ Parameter{1}, State.Dependents.FittingDefinitions.ChargeTrappingShift), 1, [])];
